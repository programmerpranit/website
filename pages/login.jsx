    ...
    <div className="container px-5 py-10 mx-auto flex">
      ...
      <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col m-auto border w-full mt-10 md:mt-0 relative z-10 shadow-md">
        ...
        <div className="relative mb-4">
          ...
          />
          <Link href={'/auth/signup'}><strong className="text-blue text-right text-xs cursor-pointer">Forgot Password</strong></Link>
        </div>
        ...
        <p className="text-sm text-gray-500 mt-3">
          New to this website <Link href={'/signup'}><strong className="text-blue cursor-pointer">Create Account</strong></Link>
        </p>
      </div>
    </div>
  );
